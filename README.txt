...
Pegel Plugin is a QGIS plugin designed to visualize Pegel stations across Germany, providing real-time water level measurements and other related data.

Features

- Visualize Pegel Stations: Displays Pegel stations with their current water levels, temperatures, and more.
...
- Click the “Graph” button to see the 30-day water level graph.
